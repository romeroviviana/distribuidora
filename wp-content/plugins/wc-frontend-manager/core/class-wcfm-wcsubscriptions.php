...
class WCFM_WCSubscriptions {
    ...
    if( wcfm_is_subscription() ) {
    	...
    	add_filter( 'wcfm_product_manage_fields_general', array( &$this, 'wcs_product_manage_fields_general' ), 30, 2 );
  ...
  /**
	...
	function wcs_product_manage_fields_general( $general_fields, $product_id ) {
		...
		$general_fields = array_slice($general_fields, 0, 5, true) +
																	...
																	array_slice($general_fields, 5, count($general_fields) - 1, true) ;
