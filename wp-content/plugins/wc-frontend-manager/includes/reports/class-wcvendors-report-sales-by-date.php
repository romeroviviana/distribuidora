...
class WC_Vendors_Report_Sales_By_Date extends WC_Admin_Report {
	...
	public function get_chart_legend() {
		...
		$legend[] = array(
			'title'            => sprintf( __( '%s items purchased', $WCFM->text_domain ), '<strong>' . $data->total_items . '</strong>' ),
			...
			jQuery(function(){
				...
				var drawGraph = function( highlight ) {
					var series = [
						...
						{
							label: "<?php echo esc_js( __( 'Number of items sold', $WCFM->text_domain ) ) ?>",
						...
						{
							label: "<?php echo esc_js( __( 'Total Earned Commission Amount', $WCFM->text_domain ) ) ?>",
						...
						{
							label: "<?php echo esc_js( __( 'Total Paid Commission Amount', $WCFM->text_domain ) ) ?>",
