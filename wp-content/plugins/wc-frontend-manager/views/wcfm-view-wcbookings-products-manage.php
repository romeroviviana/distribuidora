...
<div class="page_collapsible products_manage_availability booking" id="wcfm_products_manage_form_availability_head"><?php _e('Availability', 'woocommerce-bookings'); ?><span></span></div>
<div class="wcfm-container booking">
	<div id="wcfm_products_manage_form_availability_expander" class="wcfm-content">
		...
		$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_wcbokings_availability_fields', array(  
					...
					"_wc_booking_apply_adjacent_buffer" => array('label' => __('Adjacent Buffering?', 'woocommerce-bookings') , 'type' => 'checkbox', 'class' => 'wcfm-checkbox wcfm_ele booking', 'label_class' => 'wcfm_title booking', 'value' => 'yes', 'dfvalue' => $apply_adjacent_buffer, 'hints' => __( 'By default buffer period applies forward into the future of a booking. Enabling this option will apply adjacently ( Before and After Bookings).', 'woocommerce-bookings' ) ),
...
<div class="page_collapsible products_manage_costs booking" id="wcfm_products_manage_form_costs_head"><?php _e('Costs', 'woocommerce-bookings'); ?><span></span></div>
<div class="wcfm-container booking">
