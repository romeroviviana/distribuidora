...
<div class="collapse wcfm-collapse" id="wcfm_order_details">
  ...
  <div class="wcfm-page-headig">
		...
		<span class="wcfm-page-heading-text"><?php _e( 'Order Details', $WCFM->text_domain ); ?></span>
	</div>
	<div class="wcfm-collapse-content">
		...
		if( $allow_wp_admin_view = apply_filters( 'wcfm_allow_wp_admin_view', true ) ) {
			?>
			<a target="_blank" class="wcfm_wp_admin_view text_tip" href="<?php echo admin_url('post.php?post='.$order_id.'&action=edit'); ?>" data-tip="<?php _e( 'WP Admin View', $WCFM->text_domain ); ?>"><span class="fa fa-user-secret"></span></a>
			<?php
		}
		?>
