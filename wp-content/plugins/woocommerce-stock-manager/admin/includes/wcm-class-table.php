  ...
  /**
    ...
    public static function hidden_box( $item ){
  	...
  	public static function sku_box($product_meta, $item){
  		?>
  		  <td style="width:100px;"><input type="text" name="sku[<?php echo $item->ID; ?>]" style="width:100%" class="sku_<?php echo $item->ID; ?>" value="<?php if(!empty($product_meta['_sku'][0])){ echo $product_meta['_sku'][0]; } ?>" /></td>
  		<?php
  	} 
